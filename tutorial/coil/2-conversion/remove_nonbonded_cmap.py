...
def build_parser():
    parser = ArgumentParser(description="Make files for random coil simulations")
...
def read_input_lammps(filename, data_out_file, cmap_file, outxtc):
    two_pow1over6 = 2**(1/6)
    pair_coeffs = dict()
    output_data = []
...
if __name__ == "__main__":
    ...
    converted_input = read_input_lammps(args.i, args.otop, args.cmap, args.oxtc)
